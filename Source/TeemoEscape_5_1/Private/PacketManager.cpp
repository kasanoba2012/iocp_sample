...
void PacketManager::Init(const UINT32 max_client)
{
	...
	recv_funtion_dictionary_[(int)PACKET_ID::IN_GAME_MOVE_START] = &PacketManager::ProocessInPlayerMove;
...
void PacketManager::ReceivePacketData(const UINT32 client_index, const UINT32 size, char* P_data)
{
	...
	// 큐에 몇번 클라가 데이터 보낸지 알기 위해 클라 번호 저장
...
void PacketManager::ProocessInPlayerMove(UINT32 client_index, UINT16 packet_size, char* P_packet)
{
