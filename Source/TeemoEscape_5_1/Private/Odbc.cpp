...
void Odbc::ConnetMssql(std::wstring dbName)
{
	...
	TCHAR dsn[] = L"Driver={SQL Server};Server=shader.kr;Address=127.0.0.1,1433;Network=dbmssocn;Database=test_DB;Uid=sa;Pwd=dpsjwl2012;";
	SQLSMALLINT  cbOutCon;
...
// 인벤토리 전체 확인 조회할 대상 넣어서 처리
bool Odbc::InventoryCheckSql()
{
...
RECORD Odbc::InventoryCheck(const TCHAR* szName)
{
